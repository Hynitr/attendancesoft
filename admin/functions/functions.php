...
$a = urlencode('deguidelightschool@yahoo.com'); //Note: urlencodemust be added forusernameand
$b = urlencode('Guide64'); // passwordas encryption code for security purpose.
