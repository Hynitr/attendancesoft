    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Staff has been registered succesfully and now has an account on the school
                    portal<br /><br />
                    <small>Please complete the employment process by printing Staff Employment letter and ID card
                        below.</small>
                </h3>
