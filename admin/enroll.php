                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="surname" placeholder="Input Surname" name="surname"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Input Name" id="firstname" name="firstname"
                                            class="form-control" required>
                                    </div>
                                    <!-- /.input group -->
                                </div>
                                ...
                                <div class="form-group" hidden>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="schlst" id="schlst"
                                            placeholder="Input last school attended" value="0" class="form-control"
                                            required>
                                    </div>
                                    <!-- /.input group -->
                                </div>
                                ...
                                <div class="form-group" hidden>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="occupation" id="occupation" type="text"
                                            placeholder="Input Parent/Guardian Occupation" value="0"
                                            class="form-control" required>
                                    </div>
                                    <!-- /.input group -->
                                </div>
                                ...
                                <div class="form-group" hidden>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="add" id="add" value="0"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-group col-md-6">
                                            ...
                                            <input type="number" name="mnum" id="mnum" class="form-control"
                                                placeholder="Input Mother`s Number"
                                                data-inputmask='"mask": "99999999999"' data-mask>
                                        </div>
                                    </div>
                                    <!-- /.input group -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="input-group col-md-6">
                                            ...
                                            <input type="email" name="pword" id="pword" class="form-control"
                                                placeholder="Father Email Address" required>
                                        </div>
                                        <div class="input-group col-md-6">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">@</span>
                                            </div>
                                            <input type="email" name="rpword" id="rpword" class="form-control"
                                                placeholder="Mother Email Address" required>
                                        </div>
                                    </div>
                                    <!-- /.input group -->
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="input-group col-md-6">
                                            ...
                                            <input type="number" name="acf" id="acf" class="form-control"
                                                placeholder="Input Acceptance Fee" value="0" required>
                                        </div>
                                        <div class="input-group col-md-6">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text">NGN</span>
                                            ...
                                            <input type="number" name="schf" id="schf" class="form-control"
                                                placeholder="Input School Fees" value="0" required>
                                        </div>
                                    </div>
                                    <!-- /.input group -->
                                </div>
