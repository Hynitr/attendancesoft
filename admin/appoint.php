                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Input Surname" name="surname" id="surname"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Input Name" name="firstname" id="firstname"
                                            class="form-control" required>
                                    </div>
                                    <!-- /.input group -->
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Input Other Name" id="lastname"
                                    ...
                                    <div class="row">
                                        <div class="input-group col-md-4">
                                            ...
                                            <input type="text" name="date" id="date" placeholder="Day"
                                                class="form-control" data-inputmask='"mask": "99"' data-mask required>
                                        </div>
                                        <!-- /.input group -->
                                        <div class="input-group col-md-4">
                                            <div class="input-group-prepend">
                                        ...
                                        <div class="input-group col-md-4">
                                            ...
                                            <input type="text" name="year" id="year" placeholder="Year"
                                                class="form-control" data-inputmask='"mask": "9999"' data-mask required>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                                ...
                                <div class="form-group" hidden>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="schlst" id="schlst" value="0"
                                ...
                                <div class="form-group" hidden>
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="post" id="post" value="0"
                                ...
                                <div class="form-group" hidden>
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="subj" id="subj" value="0"
                                ...
                                <div class="form-group" hidden>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="parent" id="parent" value="0"
                                ...
                                <div class="form-group" hidden>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="occupation" id="occupation" type="text" value="0"
                                ...
                                <div class="form-group" hidden>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="add" value="0" id="add"
                                ...
                                <div class="form-group" hidden>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="add2" id="add2" value="0"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-group col-md-6">
                                            ...
                                            <input type="number" name="mnum" id="mnum" class="form-control"
                                ...
                                <div class="form-group" hidden>
                                    ...
                                    <div class="row">
                                        <div class="input-group col-md-4">
                                            ...
                                            <input type="number" name="date" id="bsm" value="0"
                                                placeholder="Basic Salary per Month" class="form-control" required>
                                        </div>
                                        <!-- /.input group -->
                                        <div class="input-group col-md-4">
                                            <div class="input-group-prepend">
                                            ...
                                            <input type="number" name="month" id="tam" value="0"
                                        ...
                                        <div class="input-group col-md-4">
                                            ...
                                            <input type="number" name="year" id="mall" value="0"
